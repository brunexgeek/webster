...
{
    WBHS_CONTINUE = 100,
    WBHS_SWITCHING_PROTOCOLS = 101,
    WBHS_OK = 200,
    WBHS_CREATED = 201,
    WBHS_ACCEPTED = 202,
    WBHS_NON_AUTHORITATIVE_INFORMATION = 203,
    WBHS_NO_CONTENT = 204,
    WBHS_RESET_CONTENT = 205,
    WBHS_PARTIAL_CONTENT = 206,
    WBHS_MULTIPLE_CHOICES = 300,
    WBHS_MOVED_PERMANENTLY = 301,
    WBHS_FOUND = 302,
    WBHS_SEE_OTHER = 303,
    WBHS_NOT_MODIFIED = 304,
    WBHS_TEMPORARY_REDIRECT = 307,
    WBHS_PERMANENT_REDIRECT = 308,
    WBHS_BAD_REQUEST = 400,
    WBHS_UNAUTHORIZED = 401,
    WBHS_FORBIDDEN = 403,
    WBHS_NOT_FOUND = 404,
    WBHS_METHOD_NOT_ALLOWED = 405,
    WBHS_NOT_ACCEPTABLE = 406,
    WBHS_PROXY_AUTHENTICATION_REQUIRED = 407,
    WBHS_REQUEST_TIMEOUT = 408,
    WBHS_CONFLICT = 409,
    WBHS_GONE = 410,
    WBHS_LENGTH_REQUIRED = 411,
    WBHS_PRECONDITION_FAILED = 412,
    WBHS_PAYLOAD_TOO_LARGE = 413,
    WBHS_URI_TOO_LONG = 414,
    WBHS_UNSUPPORTED_MEDIA_TYPE = 415,
    WBHS_RANGE_NOT_SATISFIABLE = 416,
    WBHS_EXPECTATION_FAILED = 417,
    WBHS_UNPROCESSABLE_ENTITY = 422,
    WBHS_TOO_EARLY = 425,
    WBHS_UPGRADE_REQUIRED = 426,
    WBHS_PRECONDITION_REQUIRED = 428,
    WBHS_TOO_MANY_REQUESTS = 429,
    WBHS_REQUEST_HEADER_FIELDS_TOO_LARGE = 431,
    WBHS_UNAVAILABLE_FOR_LEGAL_REASONS = 451,
    WBHS_INTERNAL_SERVER_ERROR = 500,
    WBHS_NOT_IMPLEMENTED = 501,
    WBHS_BAD_GATEWAY = 502,
    WBHS_SERVICE_UNAVAILABLE = 503,
    WBHS_GATEWAY_TIMEOUT = 504,
    WBHS_HTTP_VERSION_NOT_SUPPORTED = 505,
    WBHS_NETWORK_AUTHENTICATION_REQUIRED = 511,
};
